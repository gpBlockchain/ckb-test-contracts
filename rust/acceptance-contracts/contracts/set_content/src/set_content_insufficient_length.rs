...
///
///  case1 : spawn(content = [1:10]) -> spawn2 -> set_content([2:8])
///  result
///      set_content return 8
///      spawn can query content == [2,2,2,2,2,2,2,2,1,1]
///
pub fn program_entry() -> i8 {
    ...
    assert_eq!(content, [2, 2, 2, 2, 2, 2, 2, 2, 1, 1]);
    // debug!("result:{:?}",result);
